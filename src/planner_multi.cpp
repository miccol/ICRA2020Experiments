...
bool plan (GridWorldTrianglesMulti* model, bstate start_state, std::vector<bstate>* path_to_return, std::vector<Action>* actions_to_return, std::vector<Node>* closed_list, const bool has_heuristic)
{
